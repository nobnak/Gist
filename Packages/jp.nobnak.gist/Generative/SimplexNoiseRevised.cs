 ...
 */
	...
	public static class SimplexNoise {  // Simplex noise in 2D, 3D and 4D
		private static readonly Grad[] grad3 = new Grad[]{
			new Grad(1,1,0),new Grad(-1,1,0),new Grad(1,-1,0),new Grad(-1,-1,0),
			new Grad(1,0,1),new Grad(-1,0,1),new Grad(1,0,-1),new Grad(-1,0,-1),
			new Grad(0,1,1),new Grad(0,-1,1),new Grad(0,1,-1),new Grad(0,-1,-1)};
		
		private static readonly Grad[] grad4 = new Grad[]{
		...
		private static readonly short[] p = new short[]{151,160,137,91,90,15,
		...
		public struct Grad {
			...
			public Grad(double x, double y, double z) : this(x, y, z, 0) {}			
